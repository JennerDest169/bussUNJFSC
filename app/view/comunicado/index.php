...
<style>
  ...
  .comunicado-card.normal { border-left-color: #9C27B0; }
  .comunicado-card.importante { border-left-color: #FF9800; }
  .comunicado-card.urgente { border-left-color: #F44336; }
  
  .prioridad-icon {
    font-size: 2.5rem;
    margin-right: 15px;
  }
  .prioridad-icon.normal { color: #9C27B0; }
  .prioridad-icon.importante { color: #FF9800; }
  .prioridad-icon.urgente { color: #F44336; }
  
  .btn-nuevo-comunicado {
    padding: 20px 40px;
    font-size: 1.2rem;
    font-weight: 600;
  ...
  .btn-nuevo-comunicado:hover {
    background-color: #D32F2F !important;
    color: #fff !important;
    transform: scale(1.05);
    box-shadow: 0 5px 15px rgba(244, 67, 54, 0.4);
  }
  .btn-nuevo-comunicado i {
    margin-right: 10px;
    font-size: 1.4rem;
  }
  ...
  .estado-badge.activo .circle {
    background-color: #4CAF50;
  }
  .estado-badge.inactivo .circle {
          ...
          <div class="page-inner">
                  ...
                  <div class="card card-stats card-round">
                    <div class="card-body">
                      <div class="row align-items-center">
                        <div class="col-icon">
                          <div class="icon-big text-center bubble-shadow-small" style="background-color: #9C27B0;">
                ...
                <div class="col-sm-6 col-md-4">
                  <div class="card card-stats card-round">
                    <div class="card-body">
                      <div class="row align-items-center">
                        <div class="col-icon">
                          <div class="icon-big text-center bubble-shadow-small" style="background-color: #FF9800;">
                ...
                <div class="col-sm-6 col-md-4">
                  <div class="card card-stats card-round">
                    <div class="card-body">
                      <div class="row align-items-center">
                        <div class="col-icon">
                          <div class="icon-big text-center bubble-shadow-small" style="background-color: #F44336;">
                          ...
                          <tbody>
                            <?php if(!empty($comunicados)): ?>
                              ...
                              <tr>
                                ...
                                <td>
                                  <span class="badge badge-<?= $com['estado'] === 'Activo' ? 'success' : 'secondary' ?>">
            ...
            <?php else: ?>
              ...
              <div class="row" id="comunicadosContainer">
                <?php if(!empty($comunicados)): ?>
                  <?php foreach($comunicados as $com): 
                    $prioridad_class = strtolower($com['prioridad']);
                    $icon_map = [
      ...
      items.sort(function(a, b) {
        ...
        switch(criterio) {
          case 'fecha':
            ...
            break;
          case 'prioridad':
            const prioridadOrden = {'Normal': 3, 'Importante': 2, 'Urgente': 1};
